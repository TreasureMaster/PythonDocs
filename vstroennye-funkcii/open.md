...
* в Windows открытие консольного буфера может вернуть подкласс [io.RawIOBase](../obshie-sluzhby-operacionnoi-sistemy/io/io.rawiobase/), отличный от [io.FileIO](../obshie-sluzhby-operacionnoi-sistemy/io/io.fileio.md)
